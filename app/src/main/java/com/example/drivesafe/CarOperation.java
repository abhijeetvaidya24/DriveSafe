...
public class CarOperation extends AppCompatActivity {
    private final String DEVICE_ADDRESS = "FC:A8:9A:00:09:EE"; //MAC Address of Bluetooth Module
    ...
    int command; //string variable that will store value to be transmitted to the bluetooth module
    byte[] b;
        ...
        forward_btn.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) //MotionEvent.ACTION_DOWN is when you hold a button down
                {
                    ...
                    try {
                        outputStream.write(Integer.toHexString(1).getBytes()); //transmits the value of command to the bluetooth module
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
